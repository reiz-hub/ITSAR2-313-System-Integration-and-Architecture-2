...
async function loadEnrollmentDropdowns() {
  // Fetch each independently so one down service doesn't break both dropdowns
  ...
  try {
    ...
    // Student service unavailable — leave dropdown empty
  }
  ...
  try {
    ...
    // Course service unavailable — leave dropdown empty
  }
}
